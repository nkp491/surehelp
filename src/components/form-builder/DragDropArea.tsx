...
const DragDropArea = ({
  ...
  const calculateInitialPosition = (index: number) => {
    ...
    const GRID_HEIGHT = 1300; // Adjusted height to prevent content cutoff
  ...
  return (
    <div className="w-full overflow-y-auto">
      <div 
        className={`relative w-[832px] h-[1300px] mx-auto rounded-lg overflow-hidden transition-all duration-200 ${
