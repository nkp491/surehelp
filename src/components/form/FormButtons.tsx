  ...
  const getButtonContent = (
    ...
    return (
      <>
        ...
        <span
          className={`font-medium transition-opacity duration-200 text-center ${
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-xl mx-auto">
        <Button
          ...
          className={`
            ...
            transition-all duration-200 relative overflow-hidden min-h-[80px]
            ${
        ...
        <Button
          ...
          className={`
            ...
            transition-all duration-200 relative overflow-hidden min-h-[80px]
            ${
              loading && loadingButton === "declined"
        ...
        >
          {loading && loadingButton === "declined" && (
            <div className="absolute inset-0 bg-red-800/20 animate-pulse" />
          )}
          <div className="relative z-10 flex flex-col items-center gap-2 w-full">
            {getButtonContent(
              "declined",
