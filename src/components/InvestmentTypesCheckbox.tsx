...
const InvestmentTypesCheckbox = ({
  ...
  const handleAmountChange = (type: string, value: string) => {
    console.log(`Amount change for ${type}:`, value);
  ...
  const totalInvestmentIncome = useMemo(() => {
    ...
    console.log("Calculated total investment income:", {
      selectedInvestments,
      amounts: Object.fromEntries(
        selectedInvestments.map(type => [type, localAmounts[type]])
      ),
      total
    });
  ...
  useEffect(() => {
    console.log("Notifying parent of total investment change:", totalInvestmentIncome);
